...
const AnimatedText = () => {
  const text = "זההזמןלשחרראתעצמךאפילויותר,\n\nולהרגישאתזרםהחייםשפועםלךבגוף\n\nבסדרתהמפגשיםעםמאיראבינר.\n\nאנימזמיןאותךלגילויעצמידרךהניגון:\n\nנרגישמקומותעמוקיםבנפש,נתעוררבלייבטראנס,\n\nנכילונלעסאתההפכיםשבתוכנו,ננפץפרותקדושות,נתפלליחד,\n\nנבטאונשחרר,נצחקעדשיכאב.\n\nתוסיף רווחים";
